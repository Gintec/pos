...
@section('pcontent')
    ...
    <div class = "row" style="width:90%; margin:auto;">
        <h5 class="text-center">Sales / Purchase History for {{$customers->customer_name}} ({{$customers->customer_company}})</h5>
        @if ($csales!=NULL)
          <div>
              <a href="add_sales/{{$customers->customer_id}}" class="btn btn-small btn-floating right pulse tooltipped" data-position="left" data-tooltip="New Order"><i class="material-icons">add_shopping_cart</i></a>
          </div>
